...
const MobileNav = ({ currentUser, signOut }) => {
  return (
    <nav className="topNav">
      <div className="topNav__profile-container">
        <Avatar size={50} source={currentUser.avatar_url} />
        <div className="topNav__profile-names">
      ...
      <div className="topNav__logo-container">
        <Link to="/">
          <div className="topNav__logo-image"></div>
        </Link>
      </div>

      <ul className="topNav__navigation-container">
        <NavLink to="/" exact activeClassName="active">
          <li className="topNav__navigation-link">
            <img
              alt="feed"
        ...
        <Link to="">
          <li className="topNav__navigation-link" onClick={signOut}>
            <img
              alt="sign out"
